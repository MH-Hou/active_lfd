...
if __name__ == '__main__':
    ...
    oracle_pos_traj = np.genfromtxt('/home/oem/catkin_ws/src/active_lfd/pos_traj.csv', delimiter=' ')
    oracle_pos_traj = np.array(oracle_pos_traj)
    oracle_vel_traj = np.genfromtxt('/home/oem/catkin_ws/src/active_lfd/vel_traj.csv', delimiter=' ')
